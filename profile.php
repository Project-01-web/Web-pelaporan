...
$query = "SELECT * FROM login WHERE user_login='$username'";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $update_query = "UPDATE login SET user_login='$new_username', pass_login='$new_password' WHERE user_login='$username'";
...
<body>
    ...
    <div class="content">
        <div class="container card">
            <h3 class="text-center text-primary">Edit Profil</h3>
            <form method="POST">
                <div class="mb-3">
                    <label class="form-label">Username</label>
                    <input class="form-control" type="text" name="username" value="<?php echo $user['user_login']; ?>" required />
                </div>
                <div class="mb-3">
                ...
                <div>
                    ...
                    <a class="btn btn-primary" href="index.php?page=dashboard">Kembali</a>
                </div>
            </form>
        </div>
    </div>
